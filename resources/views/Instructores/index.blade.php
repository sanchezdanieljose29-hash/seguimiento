...
@section('content_header')
 ...
 <div class="card-body table-responsive p-0">
    ...
    <a href="{{ route('instructores.create') }}" class="btn btn-primary mb-3">Nuevo Instructor</a>
                ...
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{ $item->tblrolesadministrativos_NIS }}</td>
                      <td></td>
                      <td class="text-center">

                      <a href="{{ route('instructores.edit',  $item->NIS)}}" method="POST" class="btn-warning" >
                         @csrf
                         @method('PUT')  
                      Editar
                         </a>

                      <form action="{{ route('instructores.destroy', $item->NIS)}}" method="POST" style="display:inline;">
                      @csrf
                      @method("DELETE")
